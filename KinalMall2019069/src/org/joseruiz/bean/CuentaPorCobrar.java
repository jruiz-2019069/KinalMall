...
public class CuentaPorCobrar {
    ...
    public CuentaPorCobrar(int codigoCuentaPorCobrar, String numeroFactura, int anio, int mes, double valorNetoPago, String estadoPago, int codigoAdministracion, int codigoCliente, int codigoLocal) {
